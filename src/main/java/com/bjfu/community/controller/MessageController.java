...
import com.bjfu.community.entity.Message;
import com.bjfu.community.entity.Page;
import com.bjfu.community.entity.User;
import com.bjfu.community.service.MessageService;
...
public class MessageController implements CommunityConstant {
    ...
    public String getLetterDetail(@PathVariable("conversationId") String conversationId,
                                  @RequestParam(value = "lastPageCurrent",required = false) Integer lastPageCurrent,
        ...
        if(lastPageCurrent != null){
            model.addAttribute("lastPageCurrent", lastPageCurrent);
